...
var AccountData = function () {
    ...
    var AccountData = _classThis = /** @class */ (function () {
        function AccountData_1() {
        ...
        return AccountData_1;
    }());
    __setFunctionName(_classThis, "AccountData");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)()];
        _createdAt_decorators = [(0, typeorm_1.Column)({ type: 'date' })];
        _address_decorators = [(0, typeorm_1.Column)()];
        _bio_decorators = [(0, typeorm_1.Column)()];
        ...
        AccountData = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AccountData = _classThis;
}();
