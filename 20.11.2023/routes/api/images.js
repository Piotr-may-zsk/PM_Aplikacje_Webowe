    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            data_1.AppDataSource.initialize()
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, data_1.AppDataSource.manager.find(Image_1.Image)];
                        case 1:
                            result = _a.sent();
                            res.json(result);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, data_1.AppDataSource.manager.save(image)];
                        case 1:
                            _a.sent();
                            res.json({ "succes": "yes" });
                            return [4 /*yield*/, data_1.AppDataSource.destroy()];
...
function getImage(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            data_1.AppDataSource.initialize()
                .then(function () { return __awaiter(_this, void 0, void 0, function () {
                var imageRepository, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            imageRepository = data_1.AppDataSource.getRepository(Image_1.Image);
                            return [4 /*yield*/, imageRepository.findOneBy({ id: userId })];
                        case 1:
                            result = _a.sent();
                            res.json(result);
                            return [4 /*yield*/, data_1.AppDataSource.destroy()];
            ...
            data_1.AppDataSource.initialize()
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            imageRepository = data_1.AppDataSource.getRepository(Image_1.Image);
                            return [4 /*yield*/, imageRepository.findOneBy({ id: imageId })];
                        case 1:
                            result = _a.sent();
                            if (!(result !== null)) return [3 /*break*/, 3];
                            result = (0, updateObjectHelper_1.updateObject)(result, body);
                            //@ts-ignore
                            return [4 /*yield*/, imageRepository.save(result)];
                        case 2:
                            //@ts-ignore
                            _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            result = _a.sent();
                            if (!(result !== null)) return [3 /*break*/, 3];
                            return [4 /*yield*/, imageRepository.remove(result)];
                        case 2:
                            _a.sent();
                            res.json({ "succeded": true });
                            _a.label = 3;
