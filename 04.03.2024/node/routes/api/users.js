    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            data_1.AppDataSource.initialize()
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, data_1.AppDataSource.manager.find(User_1.User)];
                        case 1:
                            result = _a.sent();
                            res.json(result);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, data_1.AppDataSource.manager.save(user)];
                        case 2:
                            _a.sent();
                            res.json({ "succes": "yes" });
                            return [4 /*yield*/, data_1.AppDataSource.destroy()];
...
function deleteUser(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            data_1.AppDataSource.initialize()
                .then(function () { return __awaiter(_this, void 0, void 0, function () {
                var userRepository, accountRepository, result, accData;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            userRepository = data_1.AppDataSource.getRepository(User_1.User);
                        ...
                        case 1:
                            ...
                            accData = result.accountData;
                            return [4 /*yield*/, userRepository.remove(result)];
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, accountRepository.remove(accData)];
                        case 3:
                            _a.sent();
                            res.json({ "succeded": true });
                            _a.label = 4;
                        case 4: return [4 /*yield*/, data_1.AppDataSource.destroy()];
                        case 5:
                            _a.sent();
                            return [2 /*return*/];
                    }
