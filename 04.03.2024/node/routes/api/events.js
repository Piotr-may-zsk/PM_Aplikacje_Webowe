    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            data_1.AppDataSource.initialize()
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, data_1.AppDataSource.manager.find(Event_1.Event)];
                        case 1:
                            result = _a.sent();
                            res.json(result);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, data_1.AppDataSource.manager.save(event)];
                        case 1:
                            _a.sent();
                            res.json({ "succes": "yes" });
                            return [4 /*yield*/, data_1.AppDataSource.destroy()];
...
function getEvent(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            data_1.AppDataSource.initialize()
                .then(function () { return __awaiter(_this, void 0, void 0, function () {
                var eventRepository, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            eventRepository = data_1.AppDataSource.getRepository(Event_1.Event);
                            return [4 /*yield*/, eventRepository.findOneBy({ id: eventId })];
                        case 1:
                            result = _a.sent();
                            res.json(result);
                            return [4 /*yield*/, data_1.AppDataSource.destroy()];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            //@ts-ignore
                            return [4 /*yield*/, eventRepository.save(result)];
                        case 2:
                            //@ts-ignore
                            _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            result = _a.sent();
                            if (!(result !== null)) return [3 /*break*/, 3];
                            return [4 /*yield*/, eventRepository.remove(result)];
                        case 2:
                            _a.sent();
                            res.json({ "succeded": true });
                            _a.label = 3;
